...
public class EngageSyntacticSequencer extends AbstractSyntacticSequencer {

	protected EngageGrammarAccess grammarAccess;
	
	@Inject
	protected void init(IGrammarAccess access) {
		grammarAccess = (EngageGrammarAccess) access;
	}
