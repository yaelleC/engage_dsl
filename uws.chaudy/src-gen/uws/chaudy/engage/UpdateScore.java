 ...
 * <ul>
 *   <li>{@link uws.chaudy.engage.UpdateScore#getOutcome <em>Outcome</em>}</li>
 *   <li>{@link uws.chaudy.engage.UpdateScore#getPts <em>Pts</em>}</li>
 * </ul>
 * </p>
 *
 * @see uws.chaudy.engage.EngagePackage#getUpdateScore()
 * @model
 * @generated
 */
public interface UpdateScore extends EObject
{
   ...
   * @see uws.chaudy.engage.EngagePackage#getUpdateScore_Outcome()
   * @model
   * @generated
   */
  Outcome getOutcome();
  ...
  /**
   * Sets the value of the '{@link uws.chaudy.engage.UpdateScore#getOutcome <em>Outcome</em>}' reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see #setPts(Point)
   * @see uws.chaudy.engage.EngagePackage#getUpdateScore_Pts()
  ...
  /**
   * Sets the value of the '{@link uws.chaudy.engage.UpdateScore#getPts <em>Pts</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
