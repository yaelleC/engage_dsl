 ...
 * <ul>
 *   <li>{@link uws.chaudy.engage.Points#getOutcome <em>Outcome</em>}</li>
 *   <li>{@link uws.chaudy.engage.Points#getPts <em>Pts</em>}</li>
 *   <li>{@link uws.chaudy.engage.Points#isOthers <em>Others</em>}</li>
 *   <li>{@link uws.chaudy.engage.Points#getParams <em>Params</em>}</li>
 * </ul>
 * </p>
 *
 * @see uws.chaudy.engage.EngagePackage#getPoints()
 * @model
 * @generated
 */
public interface Points extends EObject
{
   ...
   * @see uws.chaudy.engage.EngagePackage#getPoints_Outcome()
   * @model
   * @generated
   */
  Outcome getOutcome();
  ...
  /**
   * Sets the value of the '{@link uws.chaudy.engage.Points#getOutcome <em>Outcome</em>}' reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see #setPts(Point)
   * @see uws.chaudy.engage.EngagePackage#getPoints_Pts()
  ...
  /**
   * Sets the value of the '{@link uws.chaudy.engage.Points#getPts <em>Pts</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see uws.chaudy.engage.EngagePackage#getPoints_Others()
   * @model
   * @generated
   */
  boolean isOthers();
  ...
  /**
   * Sets the value of the '{@link uws.chaudy.engage.Points#isOthers <em>Others</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * The list contents are of type {@link uws.chaudy.engage.Params}.
   * <!-- begin-user-doc -->
   * <p>
   ...
   * @see uws.chaudy.engage.EngagePackage#getPoints_Params()
   * @model containment="true"
   * @generated
   */
