 ...
 * <ul>
 *   <li>{@link uws.chaudy.engage.impl.ParamConditionImpl#getParams <em>Params</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ParamConditionImpl extends MinimalEObjectImpl.Container implements ParamCondition
{
  ...
  {
    return EngagePackage.Literals.PARAM_CONDITION;
  }
    ...
    if (params != null && params.eIsProxy())
    {
      ...
      if (params != oldParams)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, EngagePackage.PARAM_CONDITION__PARAMS, oldParams, params));
      }
    }
    return params;
  }
  ...
  public void setParams(Params newParams)
  {
    ...
    params = newParams;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, EngagePackage.PARAM_CONDITION__PARAMS, oldParams, params));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case EngagePackage.PARAM_CONDITION__PARAMS:
