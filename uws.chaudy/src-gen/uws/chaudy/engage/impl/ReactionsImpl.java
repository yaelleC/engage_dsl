 ...
 * <ul>
 *   <li>{@link uws.chaudy.engage.impl.ReactionsImpl#getReaction <em>Reaction</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ReactionsImpl extends MinimalEObjectImpl.Container implements Reactions
{
  ...
  {
    return EngagePackage.Literals.REACTIONS;
  }
  ...
  public EList<Reaction> getReaction()
  {
    if (reaction == null)
    {
      reaction = new EObjectContainmentEList<Reaction>(Reaction.class, this, EngagePackage.REACTIONS__REACTION);
    }
    return reaction;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case EngagePackage.REACTIONS__REACTION:
