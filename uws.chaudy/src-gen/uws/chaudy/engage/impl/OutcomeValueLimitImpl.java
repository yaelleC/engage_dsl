 ...
 * <ul>
 *   <li>{@link uws.chaudy.engage.impl.OutcomeValueLimitImpl#getOutcome <em>Outcome</em>}</li>
 *   <li>{@link uws.chaudy.engage.impl.OutcomeValueLimitImpl#getSign <em>Sign</em>}</li>
 *   <li>{@link uws.chaudy.engage.impl.OutcomeValueLimitImpl#isNegativeLimit <em>Negative Limit</em>}</li>
 *   <li>{@link uws.chaudy.engage.impl.OutcomeValueLimitImpl#getLimit <em>Limit</em>}</li>
 *   <li>{@link uws.chaudy.engage.impl.OutcomeValueLimitImpl#getTriggerReactions <em>Trigger Reactions</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class OutcomeValueLimitImpl extends MinimalEObjectImpl.Container implements OutcomeValueLimit
{
  ...
  {
    return EngagePackage.Literals.OUTCOME_VALUE_LIMIT;
  }
    ...
    if (outcome != null && outcome.eIsProxy())
    {
      ...
      if (outcome != oldOutcome)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, EngagePackage.OUTCOME_VALUE_LIMIT__OUTCOME, oldOutcome, outcome));
      }
    }
    return outcome;
  }
  ...
  public void setOutcome(Outcome newOutcome)
  {
    ...
    outcome = newOutcome;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, EngagePackage.OUTCOME_VALUE_LIMIT__OUTCOME, oldOutcome, outcome));
  }
  ...
  public void setSign(String newSign)
  {
    ...
    sign = newSign;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, EngagePackage.OUTCOME_VALUE_LIMIT__SIGN, oldSign, sign));
  }
  ...
  public void setNegativeLimit(boolean newNegativeLimit)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, EngagePackage.OUTCOME_VALUE_LIMIT__NEGATIVE_LIMIT, oldNegativeLimit, negativeLimit));
  }
  ...
  public void setLimit(int newLimit)
  {
    ...
    limit = newLimit;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, EngagePackage.OUTCOME_VALUE_LIMIT__LIMIT, oldLimit, limit));
  }
  ...
  public EList<TriggerFeedback> getTriggerReactions()
  {
    ...
    {
      triggerReactions = new EObjectContainmentEList<TriggerFeedback>(TriggerFeedback.class, this, EngagePackage.OUTCOME_VALUE_LIMIT__TRIGGER_REACTIONS);
    }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case EngagePackage.OUTCOME_VALUE_LIMIT__TRIGGER_REACTIONS:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case EngagePackage.OUTCOME_VALUE_LIMIT__OUTCOME:
        if (resolve) return getOutcome();
        return basicGetOutcome();
      case EngagePackage.OUTCOME_VALUE_LIMIT__SIGN:
        return getSign();
      case EngagePackage.OUTCOME_VALUE_LIMIT__NEGATIVE_LIMIT:
        return isNegativeLimit();
      case EngagePackage.OUTCOME_VALUE_LIMIT__LIMIT:
        return getLimit();
      case EngagePackage.OUTCOME_VALUE_LIMIT__TRIGGER_REACTIONS:
