 ...
 * <ul>
 *   <li>{@link uws.chaudy.engage.impl.ActionSequenceImpl#getAction1 <em>Action1</em>}</li>
 *   <li>{@link uws.chaudy.engage.impl.ActionSequenceImpl#isBefore <em>Before</em>}</li>
 *   <li>{@link uws.chaudy.engage.impl.ActionSequenceImpl#isAfter <em>After</em>}</li>
 *   <li>{@link uws.chaudy.engage.impl.ActionSequenceImpl#getAction2 <em>Action2</em>}</li>
 *   <li>{@link uws.chaudy.engage.impl.ActionSequenceImpl#getSequenceReactions <em>Sequence Reactions</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ActionSequenceImpl extends MinimalEObjectImpl.Container implements ActionSequence
{
  ...
  {
    return EngagePackage.Literals.ACTION_SEQUENCE;
  }
  ...
  public void setAction1(String newAction1)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, EngagePackage.ACTION_SEQUENCE__ACTION1, oldAction1, action1));
  }
  ...
  public void setBefore(boolean newBefore)
  {
    ...
    before = newBefore;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, EngagePackage.ACTION_SEQUENCE__BEFORE, oldBefore, before));
  }
  ...
  public void setAfter(boolean newAfter)
  {
    ...
    after = newAfter;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, EngagePackage.ACTION_SEQUENCE__AFTER, oldAfter, after));
  }
  ...
  public void setAction2(String newAction2)
  {
    ...
    action2 = newAction2;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, EngagePackage.ACTION_SEQUENCE__ACTION2, oldAction2, action2));
  }
  ...
  public EList<ActionReaction> getSequenceReactions()
  {
    ...
    {
      sequenceReactions = new EObjectContainmentEList<ActionReaction>(ActionReaction.class, this, EngagePackage.ACTION_SEQUENCE__SEQUENCE_REACTIONS);
    }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case EngagePackage.ACTION_SEQUENCE__SEQUENCE_REACTIONS:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case EngagePackage.ACTION_SEQUENCE__ACTION1:
        return getAction1();
      case EngagePackage.ACTION_SEQUENCE__BEFORE:
        return isBefore();
      case EngagePackage.ACTION_SEQUENCE__AFTER:
        return isAfter();
      case EngagePackage.ACTION_SEQUENCE__ACTION2:
        return getAction2();
      case EngagePackage.ACTION_SEQUENCE__SEQUENCE_REACTIONS:
