 ...
 * <ul>
 *   <li>{@link uws.chaudy.engage.impl.ReactionImpl#getParamsC <em>Params C</em>}</li>
 *   <li>{@link uws.chaudy.engage.impl.ReactionImpl#getPointsC <em>Points C</em>}</li>
 *   <li>{@link uws.chaudy.engage.impl.ReactionImpl#getFeedback <em>Feedback</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ReactionImpl extends MinimalEObjectImpl.Container implements Reaction
{
  ...
  {
    return EngagePackage.Literals.REACTION;
  }
  ...
  public NotificationChain basicSetParamsC(ParamCondition newParamsC, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, EngagePackage.REACTION__PARAMS_C, oldParamsC, newParamsC);
  ...
  public void setParamsC(ParamCondition newParamsC)
  {
    if (newParamsC != paramsC)
    {
      ...
      if (paramsC != null)
        msgs = ((InternalEObject)paramsC).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - EngagePackage.REACTION__PARAMS_C, null, msgs);
      if (newParamsC != null)
        msgs = ((InternalEObject)newParamsC).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - EngagePackage.REACTION__PARAMS_C, null, msgs);
      msgs = basicSetParamsC(newParamsC, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, EngagePackage.REACTION__PARAMS_C, newParamsC, newParamsC));
  }
  ...
  public NotificationChain basicSetPointsC(PointsCondition newPointsC, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, EngagePackage.REACTION__POINTS_C, oldPointsC, newPointsC);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setPointsC(PointsCondition newPointsC)
  {
    if (newPointsC != pointsC)
    {
      NotificationChain msgs = null;
      if (pointsC != null)
        msgs = ((InternalEObject)pointsC).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - EngagePackage.REACTION__POINTS_C, null, msgs);
      if (newPointsC != null)
        msgs = ((InternalEObject)newPointsC).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - EngagePackage.REACTION__POINTS_C, null, msgs);
      msgs = basicSetPointsC(newPointsC, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, EngagePackage.REACTION__POINTS_C, newPointsC, newPointsC));
  }
  ...
  public Feedback getFeedback()
  {
    if (feedback != null && feedback.eIsProxy())
    {
      ...
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, EngagePackage.REACTION__FEEDBACK, oldFeedback, feedback));
      }
    }
    return feedback;
  }
  ...
  public void setFeedback(Feedback newFeedback)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, EngagePackage.REACTION__FEEDBACK, oldFeedback, feedback));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case EngagePackage.REACTION__PARAMS_C:
        return basicSetParamsC(null, msgs);
      case EngagePackage.REACTION__POINTS_C:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      ...
      case EngagePackage.REACTION__POINTS_C:
        return getPointsC();
      case EngagePackage.REACTION__FEEDBACK:
