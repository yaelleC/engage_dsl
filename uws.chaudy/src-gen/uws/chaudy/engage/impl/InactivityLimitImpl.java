 ...
 * <ul>
 *   <li>{@link uws.chaudy.engage.impl.InactivityLimitImpl#getSign <em>Sign</em>}</li>
 *   <li>{@link uws.chaudy.engage.impl.InactivityLimitImpl#getLimit <em>Limit</em>}</li>
 *   <li>{@link uws.chaudy.engage.impl.InactivityLimitImpl#getTriggerReactions <em>Trigger Reactions</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class InactivityLimitImpl extends MinimalEObjectImpl.Container implements InactivityLimit
{
  ...
  {
    return EngagePackage.Literals.INACTIVITY_LIMIT;
  }
  ...
  public void setSign(String newSign)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, EngagePackage.INACTIVITY_LIMIT__SIGN, oldSign, sign));
  }
  ...
  public void setLimit(int newLimit)
  {
    ...
    limit = newLimit;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, EngagePackage.INACTIVITY_LIMIT__LIMIT, oldLimit, limit));
  }
  ...
  public EList<ActionReaction> getTriggerReactions()
  {
    ...
    {
      triggerReactions = new EObjectContainmentEList<ActionReaction>(ActionReaction.class, this, EngagePackage.INACTIVITY_LIMIT__TRIGGER_REACTIONS);
    }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case EngagePackage.INACTIVITY_LIMIT__TRIGGER_REACTIONS:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case EngagePackage.INACTIVITY_LIMIT__SIGN:
        return getSign();
      case EngagePackage.INACTIVITY_LIMIT__LIMIT:
        return getLimit();
      case EngagePackage.INACTIVITY_LIMIT__TRIGGER_REACTIONS:
