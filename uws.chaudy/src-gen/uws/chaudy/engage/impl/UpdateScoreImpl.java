 ...
 * <ul>
 *   <li>{@link uws.chaudy.engage.impl.UpdateScoreImpl#getOutcome <em>Outcome</em>}</li>
 *   <li>{@link uws.chaudy.engage.impl.UpdateScoreImpl#getPts <em>Pts</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class UpdateScoreImpl extends MinimalEObjectImpl.Container implements UpdateScore
{
  ...
  {
    return EngagePackage.Literals.UPDATE_SCORE;
  }
    ...
    if (outcome != null && outcome.eIsProxy())
    {
      ...
      if (outcome != oldOutcome)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, EngagePackage.UPDATE_SCORE__OUTCOME, oldOutcome, outcome));
      }
    }
    return outcome;
  }
  ...
  public void setOutcome(Outcome newOutcome)
  {
    ...
    outcome = newOutcome;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, EngagePackage.UPDATE_SCORE__OUTCOME, oldOutcome, outcome));
  }
  ...
  public NotificationChain basicSetPts(Point newPts, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, EngagePackage.UPDATE_SCORE__PTS, oldPts, newPts);
  ...
  public void setPts(Point newPts)
  {
    if (newPts != pts)
    {
      ...
      if (pts != null)
        msgs = ((InternalEObject)pts).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - EngagePackage.UPDATE_SCORE__PTS, null, msgs);
      if (newPts != null)
        msgs = ((InternalEObject)newPts).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - EngagePackage.UPDATE_SCORE__PTS, null, msgs);
      msgs = basicSetPts(newPts, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, EngagePackage.UPDATE_SCORE__PTS, newPts, newPts));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case EngagePackage.UPDATE_SCORE__PTS:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case EngagePackage.UPDATE_SCORE__OUTCOME:
