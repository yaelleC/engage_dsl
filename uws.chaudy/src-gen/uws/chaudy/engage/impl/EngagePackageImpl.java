 ...
 * @generated
 */
public class EngagePackageImpl extends EPackageImpl implements EngagePackage
{
  /**
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see uws.chaudy.engage.EngagePackage#eNS_URI
   * @see #init()
   * @generated
   */
  private EngagePackageImpl()
  {
    super(eNS_URI, EngageFactory.eINSTANCE);
  }
   ...
   * 
   * <p>This method is used to initialize {@link EngagePackage#eINSTANCE} when that field is accessed.
   ...
   * @generated
   */
  public static EngagePackage init()
  {
    if (isInited) return (EngagePackage)EPackage.Registry.INSTANCE.getEPackage(EngagePackage.eNS_URI);

    // Obtain or create and register package
    EngagePackageImpl theEngagePackage = (EngagePackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof EngagePackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new EngagePackageImpl());

    isInited = true;

    // Create package meta-data objects
    theEngagePackage.createPackageContents();

    // Initialize created meta-data
    theEngagePackage.initializePackageContents();

    // Mark meta-data to indicate it can't be changed
    theEngagePackage.freeze();

  
    // Update the registry and return the package
    EPackage.Registry.INSTANCE.put(EngagePackage.eNS_URI, theEngagePackage);
    return theEngagePackage;
  }
  ...
  {
    return (EngageFactory)getEFactoryInstance();
  }
  ...
  public void initializePackageContents()
  {
    ...
    initEClass(enumEClass, uws.chaudy.engage.Enum.class, "Enum", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getEnum_EnumValues(), ecorePackage.getEString(), "enumValues", null, 0, -1, uws.chaudy.engage.Enum.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
