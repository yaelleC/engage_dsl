 ...
 * <ul>
 *   <li>{@link uws.chaudy.engage.impl.LearningOutcomesImpl#getOutcomes <em>Outcomes</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class LearningOutcomesImpl extends MinimalEObjectImpl.Container implements LearningOutcomes
{
  ...
  {
    return EngagePackage.Literals.LEARNING_OUTCOMES;
  }
  ...
  public EList<Outcome> getOutcomes()
  {
    if (outcomes == null)
    {
      outcomes = new EObjectContainmentEList<Outcome>(Outcome.class, this, EngagePackage.LEARNING_OUTCOMES__OUTCOMES);
    }
    return outcomes;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case EngagePackage.LEARNING_OUTCOMES__OUTCOMES:
