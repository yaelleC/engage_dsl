 ...
 * <ul>
 *   <li>{@link uws.chaudy.engage.impl.ActionReactionImpl#getUpdateScore <em>Update Score</em>}</li>
 *   <li>{@link uws.chaudy.engage.impl.ActionReactionImpl#getTriggerFeedback <em>Trigger Feedback</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ActionReactionImpl extends MinimalEObjectImpl.Container implements ActionReaction
{
  ...
  {
    return EngagePackage.Literals.ACTION_REACTION;
  }
  ...
  public NotificationChain basicSetUpdateScore(UpdateScore newUpdateScore, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, EngagePackage.ACTION_REACTION__UPDATE_SCORE, oldUpdateScore, newUpdateScore);
  ...
  public void setUpdateScore(UpdateScore newUpdateScore)
  {
    if (newUpdateScore != updateScore)
    {
      ...
      if (updateScore != null)
        msgs = ((InternalEObject)updateScore).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - EngagePackage.ACTION_REACTION__UPDATE_SCORE, null, msgs);
      if (newUpdateScore != null)
        msgs = ((InternalEObject)newUpdateScore).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - EngagePackage.ACTION_REACTION__UPDATE_SCORE, null, msgs);
      msgs = basicSetUpdateScore(newUpdateScore, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, EngagePackage.ACTION_REACTION__UPDATE_SCORE, newUpdateScore, newUpdateScore));
  }
  ...
  public NotificationChain basicSetTriggerFeedback(TriggerFeedback newTriggerFeedback, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, EngagePackage.ACTION_REACTION__TRIGGER_FEEDBACK, oldTriggerFeedback, newTriggerFeedback);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setTriggerFeedback(TriggerFeedback newTriggerFeedback)
  {
    if (newTriggerFeedback != triggerFeedback)
    {
      ...
      if (triggerFeedback != null)
        msgs = ((InternalEObject)triggerFeedback).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - EngagePackage.ACTION_REACTION__TRIGGER_FEEDBACK, null, msgs);
      if (newTriggerFeedback != null)
        msgs = ((InternalEObject)newTriggerFeedback).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - EngagePackage.ACTION_REACTION__TRIGGER_FEEDBACK, null, msgs);
      msgs = basicSetTriggerFeedback(newTriggerFeedback, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, EngagePackage.ACTION_REACTION__TRIGGER_FEEDBACK, newTriggerFeedback, newTriggerFeedback));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case EngagePackage.ACTION_REACTION__UPDATE_SCORE:
        return basicSetUpdateScore(null, msgs);
      case EngagePackage.ACTION_REACTION__TRIGGER_FEEDBACK:
