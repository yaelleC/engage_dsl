 ...
 * <ul>
 *   <li>{@link uws.chaudy.engage.impl.TimingImpl#isBefore <em>Before</em>}</li>
 *   <li>{@link uws.chaudy.engage.impl.TimingImpl#isAfter <em>After</em>}</li>
 *   <li>{@link uws.chaudy.engage.impl.TimingImpl#getLimit <em>Limit</em>}</li>
 *   <li>{@link uws.chaudy.engage.impl.TimingImpl#getTimingReactions <em>Timing Reactions</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TimingImpl extends MinimalEObjectImpl.Container implements Timing
{
  ...
  {
    return EngagePackage.Literals.TIMING;
  }
  ...
  public void setBefore(boolean newBefore)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, EngagePackage.TIMING__BEFORE, oldBefore, before));
  }
  ...
  public void setAfter(boolean newAfter)
  {
    ...
    after = newAfter;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, EngagePackage.TIMING__AFTER, oldAfter, after));
  }
  ...
  public void setLimit(int newLimit)
  {
    ...
    limit = newLimit;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, EngagePackage.TIMING__LIMIT, oldLimit, limit));
  }
  ...
  public EList<ActionReaction> getTimingReactions()
  {
    ...
    {
      timingReactions = new EObjectContainmentEList<ActionReaction>(ActionReaction.class, this, EngagePackage.TIMING__TIMING_REACTIONS);
    }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case EngagePackage.TIMING__TIMING_REACTIONS:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case EngagePackage.TIMING__BEFORE:
        return isBefore();
      case EngagePackage.TIMING__AFTER:
        return isAfter();
      case EngagePackage.TIMING__LIMIT:
        return getLimit();
      case EngagePackage.TIMING__TIMING_REACTIONS:
