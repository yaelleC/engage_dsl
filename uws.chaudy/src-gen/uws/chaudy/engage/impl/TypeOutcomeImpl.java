 ...
 * <ul>
 *   <li>{@link uws.chaudy.engage.impl.TypeOutcomeImpl#isKnowledge <em>Knowledge</em>}</li>
 *   <li>{@link uws.chaudy.engage.impl.TypeOutcomeImpl#isSkill <em>Skill</em>}</li>
 *   <li>{@link uws.chaudy.engage.impl.TypeOutcomeImpl#isCompetence <em>Competence</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TypeOutcomeImpl extends MinimalEObjectImpl.Container implements TypeOutcome
{
  ...
  {
    return EngagePackage.Literals.TYPE_OUTCOME;
  }
  ...
  public void setKnowledge(boolean newKnowledge)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, EngagePackage.TYPE_OUTCOME__KNOWLEDGE, oldKnowledge, knowledge));
  }
  ...
  public void setSkill(boolean newSkill)
  {
    ...
    skill = newSkill;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, EngagePackage.TYPE_OUTCOME__SKILL, oldSkill, skill));
  }
  ...
  public void setCompetence(boolean newCompetence)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, EngagePackage.TYPE_OUTCOME__COMPETENCE, oldCompetence, competence));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case EngagePackage.TYPE_OUTCOME__KNOWLEDGE:
        return isKnowledge();
      case EngagePackage.TYPE_OUTCOME__SKILL:
        return isSkill();
      case EngagePackage.TYPE_OUTCOME__COMPETENCE:
        return isCompetence();
    }
