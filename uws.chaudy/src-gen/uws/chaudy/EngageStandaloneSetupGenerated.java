...
public class EngageStandaloneSetupGenerated implements ISetup {
	...
	if (!EPackage.Registry.INSTANCE.containsKey("http://www.chaudy.uws/Engage")) {
		...
		Resource.Factory.Registry.INSTANCE.getExtensionToFactoryMap().put("engage", resourceFactory);
		org.eclipse.xtext.resource.IResourceServiceProvider.Registry.INSTANCE.getExtensionToFactoryMap().put("engage", serviceProvider);
