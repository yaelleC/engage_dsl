 ...
 * <ul>
 *   <li>{@link uws.engage.dsl.assess.Trigger#getPerf <em>Perf</em>}</li>
 *   <li>{@link uws.engage.dsl.assess.Trigger#getInactivity <em>Inactivity</em>}</li>
 * </ul>
 * </p>
 *
 * @see uws.engage.dsl.assess.AssessPackage#getTrigger()
 * @model
 * @generated
 */
public interface Trigger extends EObject
{
   ...
   * @see uws.engage.dsl.assess.AssessPackage#getTrigger_Perf()
  ...
  /**
   * Sets the value of the '{@link uws.engage.dsl.assess.Trigger#getPerf <em>Perf</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see uws.engage.dsl.assess.AssessPackage#getTrigger_Inactivity()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link uws.engage.dsl.assess.Trigger#getInactivity <em>Inactivity</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
