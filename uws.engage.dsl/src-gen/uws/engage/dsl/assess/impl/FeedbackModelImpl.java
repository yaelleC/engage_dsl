 ...
 * <ul>
 *   <li>{@link uws.engage.dsl.assess.impl.FeedbackModelImpl#getTriggers <em>Triggers</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class FeedbackModelImpl extends MinimalEObjectImpl.Container implements FeedbackModel
{
  ...
  {
    return AssessPackage.Literals.FEEDBACK_MODEL;
  }
  ...
  public EList<Trigger> getTriggers()
  {
    if (triggers == null)
    {
      triggers = new EObjectContainmentEList<Trigger>(Trigger.class, this, AssessPackage.FEEDBACK_MODEL__TRIGGERS);
    }
    return triggers;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case AssessPackage.FEEDBACK_MODEL__TRIGGERS:
