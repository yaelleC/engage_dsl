 ...
 * <ul>
 *   <li>{@link uws.engage.dsl.assess.impl.TriggerImpl#getPerf <em>Perf</em>}</li>
 *   <li>{@link uws.engage.dsl.assess.impl.TriggerImpl#getInactivity <em>Inactivity</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TriggerImpl extends MinimalEObjectImpl.Container implements Trigger
{
  ...
  {
    return AssessPackage.Literals.TRIGGER;
  }
  ...
  public NotificationChain basicSetPerf(OutcomeValueLimit newPerf, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AssessPackage.TRIGGER__PERF, oldPerf, newPerf);
  ...
  public void setPerf(OutcomeValueLimit newPerf)
  {
    if (newPerf != perf)
    {
      ...
      if (perf != null)
        msgs = ((InternalEObject)perf).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AssessPackage.TRIGGER__PERF, null, msgs);
      if (newPerf != null)
        msgs = ((InternalEObject)newPerf).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AssessPackage.TRIGGER__PERF, null, msgs);
      msgs = basicSetPerf(newPerf, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AssessPackage.TRIGGER__PERF, newPerf, newPerf));
  }
  ...
  public NotificationChain basicSetInactivity(InactivityLimit newInactivity, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AssessPackage.TRIGGER__INACTIVITY, oldInactivity, newInactivity);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setInactivity(InactivityLimit newInactivity)
  {
    if (newInactivity != inactivity)
    {
      NotificationChain msgs = null;
      if (inactivity != null)
        msgs = ((InternalEObject)inactivity).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AssessPackage.TRIGGER__INACTIVITY, null, msgs);
      if (newInactivity != null)
        msgs = ((InternalEObject)newInactivity).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AssessPackage.TRIGGER__INACTIVITY, null, msgs);
      msgs = basicSetInactivity(newInactivity, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AssessPackage.TRIGGER__INACTIVITY, newInactivity, newInactivity));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case AssessPackage.TRIGGER__PERF:
        return basicSetPerf(null, msgs);
      case AssessPackage.TRIGGER__INACTIVITY:
