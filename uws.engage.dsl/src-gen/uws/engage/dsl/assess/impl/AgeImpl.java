 ...
 * <ul>
 *   <li>{@link uws.engage.dsl.assess.impl.AgeImpl#getAgeMin <em>Age Min</em>}</li>
 *   <li>{@link uws.engage.dsl.assess.impl.AgeImpl#getAgeMax <em>Age Max</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class AgeImpl extends MinimalEObjectImpl.Container implements Age
{
  ...
  {
    return AssessPackage.Literals.AGE;
  }
  ...
  public void setAgeMin(int newAgeMin)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AssessPackage.AGE__AGE_MIN, oldAgeMin, ageMin));
  }
  ...
  public void setAgeMax(int newAgeMax)
  {
    ...
    ageMax = newAgeMax;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AssessPackage.AGE__AGE_MAX, oldAgeMax, ageMax));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case AssessPackage.AGE__AGE_MIN:
        return getAgeMin();
      case AssessPackage.AGE__AGE_MAX:
        return getAgeMax();
    }
