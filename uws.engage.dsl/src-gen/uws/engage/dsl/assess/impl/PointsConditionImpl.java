 ...
 * <ul>
 *   <li>{@link uws.engage.dsl.assess.impl.PointsConditionImpl#getKeyWd <em>Key Wd</em>}</li>
 *   <li>{@link uws.engage.dsl.assess.impl.PointsConditionImpl#getSign <em>Sign</em>}</li>
 *   <li>{@link uws.engage.dsl.assess.impl.PointsConditionImpl#getValue <em>Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PointsConditionImpl extends MinimalEObjectImpl.Container implements PointsCondition
{
  ...
  {
    return AssessPackage.Literals.POINTS_CONDITION;
  }
  ...
  public void setKeyWd(String newKeyWd)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AssessPackage.POINTS_CONDITION__KEY_WD, oldKeyWd, keyWd));
  }
  ...
  public void setSign(String newSign)
  {
    ...
    sign = newSign;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AssessPackage.POINTS_CONDITION__SIGN, oldSign, sign));
  }
  ...
  public NotificationChain basicSetValue(Point newValue, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AssessPackage.POINTS_CONDITION__VALUE, oldValue, newValue);
  ...
  public void setValue(Point newValue)
  {
    if (newValue != value)
    {
      ...
      if (value != null)
        msgs = ((InternalEObject)value).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AssessPackage.POINTS_CONDITION__VALUE, null, msgs);
      if (newValue != null)
        msgs = ((InternalEObject)newValue).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AssessPackage.POINTS_CONDITION__VALUE, null, msgs);
      msgs = basicSetValue(newValue, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AssessPackage.POINTS_CONDITION__VALUE, newValue, newValue));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case AssessPackage.POINTS_CONDITION__VALUE:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case AssessPackage.POINTS_CONDITION__KEY_WD:
        return getKeyWd();
      case AssessPackage.POINTS_CONDITION__SIGN:
        return getSign();
      case AssessPackage.POINTS_CONDITION__VALUE:
        return getValue();
    }
