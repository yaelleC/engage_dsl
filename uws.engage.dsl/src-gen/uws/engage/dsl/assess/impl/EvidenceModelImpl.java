 ...
 * <ul>
 *   <li>{@link uws.engage.dsl.assess.impl.EvidenceModelImpl#getActions <em>Actions</em>}</li>
 *   <li>{@link uws.engage.dsl.assess.impl.EvidenceModelImpl#getTimerActions <em>Timer Actions</em>}</li>
 *   <li>{@link uws.engage.dsl.assess.impl.EvidenceModelImpl#getActionSequence <em>Action Sequence</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class EvidenceModelImpl extends MinimalEObjectImpl.Container implements EvidenceModel
{
  ...
  {
    return AssessPackage.Literals.EVIDENCE_MODEL;
  }
  ...
  public EList<Action> getActions()
  {
    if (actions == null)
    {
      actions = new EObjectContainmentEList<Action>(Action.class, this, AssessPackage.EVIDENCE_MODEL__ACTIONS);
    }
    return actions;
  }
  ...
  public NotificationChain basicSetTimerActions(TimerActions newTimerActions, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AssessPackage.EVIDENCE_MODEL__TIMER_ACTIONS, oldTimerActions, newTimerActions);
  ...
  public void setTimerActions(TimerActions newTimerActions)
  {
    if (newTimerActions != timerActions)
    {
      ...
      if (timerActions != null)
        msgs = ((InternalEObject)timerActions).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AssessPackage.EVIDENCE_MODEL__TIMER_ACTIONS, null, msgs);
      if (newTimerActions != null)
        msgs = ((InternalEObject)newTimerActions).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AssessPackage.EVIDENCE_MODEL__TIMER_ACTIONS, null, msgs);
      msgs = basicSetTimerActions(newTimerActions, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AssessPackage.EVIDENCE_MODEL__TIMER_ACTIONS, newTimerActions, newTimerActions));
  }
  ...
  public NotificationChain basicSetActionSequence(ActionSequences newActionSequence, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AssessPackage.EVIDENCE_MODEL__ACTION_SEQUENCE, oldActionSequence, newActionSequence);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setActionSequence(ActionSequences newActionSequence)
  {
    if (newActionSequence != actionSequence)
    {
      ...
      if (actionSequence != null)
        msgs = ((InternalEObject)actionSequence).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AssessPackage.EVIDENCE_MODEL__ACTION_SEQUENCE, null, msgs);
      if (newActionSequence != null)
        msgs = ((InternalEObject)newActionSequence).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AssessPackage.EVIDENCE_MODEL__ACTION_SEQUENCE, null, msgs);
      msgs = basicSetActionSequence(newActionSequence, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AssessPackage.EVIDENCE_MODEL__ACTION_SEQUENCE, newActionSequence, newActionSequence));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case AssessPackage.EVIDENCE_MODEL__ACTIONS:
        return ((InternalEList<?>)getActions()).basicRemove(otherEnd, msgs);
      case AssessPackage.EVIDENCE_MODEL__TIMER_ACTIONS:
        return basicSetTimerActions(null, msgs);
      case AssessPackage.EVIDENCE_MODEL__ACTION_SEQUENCE:
