 ...
 * <ul>
 *   <li>{@link uws.engage.dsl.assess.ActionSequence#getAction1 <em>Action1</em>}</li>
 *   <li>{@link uws.engage.dsl.assess.ActionSequence#isBefore <em>Before</em>}</li>
 *   <li>{@link uws.engage.dsl.assess.ActionSequence#isAfter <em>After</em>}</li>
 *   <li>{@link uws.engage.dsl.assess.ActionSequence#getAction2 <em>Action2</em>}</li>
 *   <li>{@link uws.engage.dsl.assess.ActionSequence#getSequenceReactions <em>Sequence Reactions</em>}</li>
 * </ul>
 * </p>
 *
 * @see uws.engage.dsl.assess.AssessPackage#getActionSequence()
 * @model
 * @generated
 */
public interface ActionSequence extends EObject
{
   ...
   * @see uws.engage.dsl.assess.AssessPackage#getActionSequence_Action1()
   * @model
   * @generated
   */
  String getAction1();
  ...
  /**
   * Sets the value of the '{@link uws.engage.dsl.assess.ActionSequence#getAction1 <em>Action1</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see uws.engage.dsl.assess.AssessPackage#getActionSequence_Before()
   * @model
   * @generated
   */
  boolean isBefore();
  ...
  /**
   * Sets the value of the '{@link uws.engage.dsl.assess.ActionSequence#isBefore <em>Before</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see uws.engage.dsl.assess.AssessPackage#getActionSequence_After()
   * @model
   * @generated
   */
  boolean isAfter();
  ...
  /**
   * Sets the value of the '{@link uws.engage.dsl.assess.ActionSequence#isAfter <em>After</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see uws.engage.dsl.assess.AssessPackage#getActionSequence_Action2()
   * @model
   * @generated
   */
  String getAction2();
  ...
  /**
   * Sets the value of the '{@link uws.engage.dsl.assess.ActionSequence#getAction2 <em>Action2</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see uws.engage.dsl.assess.AssessPackage#getActionSequence_SequenceReactions()
