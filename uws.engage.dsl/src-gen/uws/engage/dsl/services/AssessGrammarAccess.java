...
* generated by Xtext
*/
package uws.engage.dsl.services;
...
@Singleton
public class AssessGrammarAccess extends AbstractGrammarElementFinder {
	...
	private final GameDescriptionElements pGameDescription;
	private final AgeElements pAge;
	private final PlayerDescriptionElements pPlayerDescription;
	private final CharacteristicElements pCharacteristic;
	private final LearningOutcomesElements pLearningOutcomes;
	private final OutcomeElements pOutcome;
	private final TypeOutcomeElements pTypeOutcome;
	private final FeedbackMessagesElements pFeedbackMessages;
	private final FeedbackElements pFeedback;
	private final TypeFeedbackElements pTypeFeedback;
	private final EvidenceModelElements pEvidenceModel;
	private final ActionSequencesElements pActionSequences;
	private final ActionSequenceElements pActionSequence;
	private final TimerActionsElements pTimerActions;
	private final TimerActionElements pTimerAction;
	private final TimingElements pTiming;
	private final ActionReactionElements pActionReaction;
	...
	private final ReactionsElements pReactions;
	private final ReactionElements pReaction;
	private final ParamConditionElements pParamCondition;
	private final PointsConditionElements pPointsCondition;
	private final PointsKeyWdElements pPointsKeyWd;
	private final FeedbackModelElements pFeedbackModel;
	...
	@Inject
	public AssessGrammarAccess(GrammarProvider grammarProvider,
		...
		this.pGameDescription = new GameDescriptionElements();
		this.pAge = new AgeElements();
		this.pPlayerDescription = new PlayerDescriptionElements();
		this.pCharacteristic = new CharacteristicElements();
		this.pLearningOutcomes = new LearningOutcomesElements();
		this.pOutcome = new OutcomeElements();
		this.pTypeOutcome = new TypeOutcomeElements();
		this.pFeedbackMessages = new FeedbackMessagesElements();
		this.pFeedback = new FeedbackElements();
		this.pTypeFeedback = new TypeFeedbackElements();
		this.pEvidenceModel = new EvidenceModelElements();
		this.pActionSequences = new ActionSequencesElements();
		this.pActionSequence = new ActionSequenceElements();
		this.pTimerActions = new TimerActionsElements();
		this.pTimerAction = new TimerActionElements();
		this.pTiming = new TimingElements();
		this.pActionReaction = new ActionReactionElements();
		...
		this.pReactions = new ReactionsElements();
		this.pReaction = new ReactionElements();
		this.pParamCondition = new ParamConditionElements();
		this.pPointsCondition = new PointsConditionElements();
		this.pPointsKeyWd = new PointsKeyWdElements();
		this.pFeedbackModel = new FeedbackModelElements();
	...
	protected Grammar internalFindGrammar(GrammarProvider grammarProvider) {
		...
		while (grammar != null) {
			if ("uws.engage.dsl.Assess".equals(grammar.getName())) {
				return grammar;
			}
